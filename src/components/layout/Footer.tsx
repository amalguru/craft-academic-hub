          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@educraftprojects.com" className="text-gray-600 hover:text-eduBlue-600 transition-colors">
                  info@educraftprojects.com
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Phone size={16} className="text-eduBlue-600" />
                <a href="tel:+918888888888" className="text-gray-600 hover:text-eduBlue-600 transition-colors">
                  +91 888 888 8888
                </a>
              </li>
              <li className="mt-4">
